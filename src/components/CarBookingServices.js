...
//                           // height: 100%; /* Set height to fully fill container */
          ...
          *, *::before, *::after {
          ...
          @media (max-width: 768px) {
            ...
            .select-container2 {
              ...
              object-fit: contain; /* Ensure the images fit fully within the container */
            }
  
            .row-image img {
              width: 100% !important; /* Ensure images fit the container */
              // height: 35vh !important; /* Maintain aspect ratio */
              object-fit: contain; /* Ensure the full image is visible without cropping */
              max-height: 100%; /* Allow the image to scale while maintaining visibility */
            }
              .imgdiv{
            ...
            .select-container2 .col {
              padding: 0.5rem !important; /* Add some padding to avoid image collision */
            }
          }
        `}
      </style>
